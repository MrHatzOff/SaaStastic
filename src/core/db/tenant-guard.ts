...
// Type definitions for Prisma middleware parameters
type PrismaAction = Prisma.PrismaAction
type PrismaModel = string
...
function handleDelete(
  ...
  const newParams: PrismaParams = {
    ...params,
    action: (params.action === 'delete' ? 'update' : 'updateMany') as PrismaAction,
    args: {
      ...args,
      where: {
        ...args.where,
